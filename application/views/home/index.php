...
<html lang="en">
  ...
  <head>
    ...
    <!-- Plugin CSS -->
    <link href="<?= base_url(); ?>public/js/plugins/datatables/dataTables.bootstrap4.css" rel="stylesheet">
  ...
  <body class="fixed-nav" id="page-top">
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a href="<?= base_url(); ?>#" class="card-footer text-white clearfix small z-1">
          ...
          <div class="col-lg-8">
            ...
            <div class="card-columns">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <h6 class="card-title mb-1">
                    <a href="<?= base_url(); ?>#">David Miller</a>
                  </h6>
                  <p class="card-text small">These waves are looking pretty good today!
                    <a href="<?= base_url(); ?>#">#surfsup</a>
                  </p>
                </div>
                <hr class="my-0">
                <div class="card-body py-2 small">
                  <a class="mr-3 d-inline-block" href="<?= base_url(); ?>#">
                ...
                <div class="card-body small bg-faded">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="mt-0 mb-1">
                        <a href="<?= base_url(); ?>#">John Smith</a>
                      </h6>
                      Very nice! I wish I was there! That looks amazing!
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                          <a href="<?= base_url(); ?>#">Like</a>
                        </li>
                        <li class="list-inline-item">
                          ·
                        </li>
                        <li class="list-inline-item">
                          <a href="<?= base_url(); ?>#">Reply</a>
                        </li>
                      </ul>
                      <div class="media mt-3">
                        <a class="d-flex pr-3" href="<?= base_url(); ?>#">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text small">Another day at the office...
                    <a href="<?= base_url(); ?>#">#workinghardorhardlyworking</a>
                  </p>
                </div>
                <hr class="my-0">
                <div class="card-body py-2 small">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <h6 class="card-title mb-1">
                    <a href="<?= base_url(); ?>#">Jeffery Wellings</a>
                  </h6>
                  <p class="card-text small">Nice shot from the skate park!
                    <a href="<?= base_url(); ?>#">#kickflip</a>
                    <a href="<?= base_url(); ?>#">#holdmybeer</a>
                    <a href="<?= base_url(); ?>#">#igotthis</a>
                  </p>
                </div>
                <hr class="my-0">
                <div class="card-body py-2 small">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text small">It's hot, and I might be lost...
                    <a href="<?= base_url(); ?>#">#desert</a>
                    <a href="<?= base_url(); ?>#">#water</a>
                    <a href="<?= base_url(); ?>#">#anyonehavesomewater</a>
                    <a href="<?= base_url(); ?>#">#noreally</a>
                    <a href="<?= base_url(); ?>#">#thirsty</a>
                    <a href="<?= base_url(); ?>#">#dehydration</a>
                  </p>
                </div>
                <hr class="my-0">
                <div class="card-body py-2 small">
    ...
    <script src="<?= base_url(); ?>public/js/plugins/jquery/jquery.min.js"></script>
    <script src="<?= base_url(); ?>public/js/plugins/popper/popper.min.js"></script>
    <script src="<?= base_url(); ?>public/bootstrap/js/bootstrap.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="<?= base_url(); ?>public/js/plugins/jquery-easing/jquery.easing.min.js"></script>
    <script src="<?= base_url(); ?>public/js/plugins/chart.js/Chart.min.js"></script>
    <script src="<?= base_url(); ?>public/js/plugins/datatables/jquery.dataTables.js"></script>
    <script src="<?= base_url(); ?>public/js/plugins/datatables/dataTables.bootstrap4.js"></script>
